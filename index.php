...
<head>
    ...
    <title>Aplikasi catatan kita - Login</title>
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">Selamat Datang DI Aplikasi catatan kita</h1>
                                    ...
                                    <form class="user" method="post" action="proses_login.php">
                                        ...
                                        <button type="submit" class="btn btn-dark customgradient1 btn-user btn-block" style="border:none;">
                                            <i class="fa fa-spinner"></i> Login
                                        </button>
                                        <hr>
                                        <a href="register.php" class="btn btn-facebook btn-user btn-block customgradient1" style="border:none;" >
