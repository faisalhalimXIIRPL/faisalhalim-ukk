...
<head>
    ...
    <title>Aplikasi catatan kita - Register</title>
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">Register Akun Aplikasi catatan kita</h1>
                                    ...
                                    <form class="user" method="post" action="proses_register.php">
                                        ...
                                        <button type="submit" class="btn btn-dark customgradient btn-user btn-block" style="border:none;" >
                                            <i class="fa fa-spinner"></i> Register
                                        </button>
                                        <hr>
                                        <a href="index.php" class="btn btn-dark customgradient btn-user btn-block" style="border:none;">
